...
class Riwayat_kerja_nonpegawai_dokter_sub_spesialis_kontrak extends CI_Controller {
	...
	public function index()
	{
		...
		$data["row"] = $this->riwayat_kerja_nonpegawai_m->dokter_sub_spesialis_kontrak();
