	...
	<div class="min-height-200px">
		<div class="page-header">
			<div class="row">
				<div class="col-md-6">
					<div class="title">
						<h4><?=ucfirst($page)?> Arsip Nonpegawai Dokter </h4>
					</div>
		...
		<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
			<form method="post" action="<?=site_url('Cuti_nonpegawai/proses')?>" enctype="multipart/form-data">
					<div class="clearfix">
						<div class="pull-left">
							...
							<div class="form-group">
								...
								<select class="custom-select form-control" id="nik" name="nik" value="<?= $row->nama?>" required>
									...
									<?php foreach($nik->result() as $key =>$data){ ?>
										<!-- <option value="<?=$data->nik?>" <?=$data->nik == $row->nik ? "selected" : null?> ><?=$data->nama?></option> -->
