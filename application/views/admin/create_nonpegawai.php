	...
	<div class="min-height-200px">
		<div class="page-header">
			<div class="row">
				<div class="col-md-6">
					<div class="title">
						<h4><?=ucfirst($page)?> Data Non-Pegawai</h4>
					</div>
		...
		<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
			<form method="post" action="<?=site_url('Nonpegawai/proses')?>" enctype="multipart/form-data">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue">Identitas nonpegawai</h4>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select class="custom-select form-control" id="status_karyawan" name="status_karyawan" value="<?= $row->status_karyawan?>" required>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<?php if($page == 'edit') {
									if($row->foto_nonpegawai != null){ ?>
										<div>
											<img src="<?=base_url('uploads/foto_nonpegawai/'.$row->foto_nonpegawai)?>" alt="" class="avatar-photo">
										</div>
									<?php
									}
								} ?>
								<input type="file" class="form-control-file form-control height-auto" id="foto_nonpegawai" name="foto_nonpegawai" value="">
								<!-- <input type="file" class="form-control-file form-control height-auto" id="foto_dokter_nonpegawai" name="foto_dokter_nonpegawai" value="<?= $row->foto_dokter_nonpegawai?>"> -->
                            </div>
                        </div>
					</div>
					...
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue">Kenonpegawai</h4>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
						...
						<!-- <div class="col-md-6">
							<div class="form-group">
								<label>Status Karyawan :</label>
								<input type="text" class="form-control" id="status_nonpegawai" name="status_nonpegawai" value="<?= $row->status_nonpegawai?>" required>
							</div>
						</div> -->
						<div class="col-md-6">
							<div class="form-group">
