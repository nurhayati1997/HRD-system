	...
	<div class="min-height-200px">
		<div class="page-header">
			<div class="row">
				<div class="col-md-6">
					<div class="title">
						<h4><?=ucfirst($page)?> Riwayat Pekerjaan Pegawai </h4>
					</div>
		...
		<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
			<form method="post" action="<?=site_url('Riwayat_kerja_pegawai/proses')?>" enctype="multipart/form-data">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue">Riwayat Pekerjaan Pegawai</h4>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
