			...
			<div class="min-height-200px">
				<div class="page-header">
					<div class="row">
						...
						<div class="col-md-6 col-sm-12 text-right">
							<div class="btn-list">
								<a class="btn btn-primary" href="<?=site_url('Cuti_nonpegawai/create/')?>" role="button">Tambah Data</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h5 class="text-blue">Cuti Nonpegawai RSUD Syarifah Ambami</h5>
						</div>
					</div>
					<div class="row">
									...
									<td>
										...
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item" href="<?=site_url('Cuti_nonpegawai/edit/'.$data->cuti_id)?>" ><i class="fa fa-pencil"></i> Edit</a>
												<a class="dropdown-item" href="<?=site_url('Cuti_nonpegawai/delete/'.$data->cuti_id)?>" onclick="return confirm ('yakin dihapus ?')"><i class="fa fa-trash"></i> Hapus</a>
											</div>
										</div>
									</td>
								</tr>
